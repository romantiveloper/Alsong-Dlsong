...
from .views import song_list,search_view, add_to_search,add_to_tjlist,ky_song_list,add_to_kylist, SearchView
...
urlpatterns = [
    ...
    path('search/', SearchView.as_view(), name='song-search'),
